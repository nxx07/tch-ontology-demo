 ...
 * [tch.yml](tch.yml)
     * Determines how your purl.obolibrary.org/obo/tch/ redirects will be handled
     ...
     * Paste in the contents of [tch.yml](tch.yml)
 ...
 * [tch.md](tch.md)
     ...
     * Paste in the contents of [tch.md](tch.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
